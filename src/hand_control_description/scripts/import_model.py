...
DESCRIPTION_PACKAGE = 'hand_control_description'
TEXT_SUFFIXES = {
    '.csv',
    '.launch',
    '.py',
...
def parse_args():
    parser = argparse.ArgumentParser(description='Import a vendor hand model into hand_control_description/models.')
