...
# -*- coding: utf-8 -*-
"""
DH116S-L000-A1 灵巧手 MuJoCo 交互仿真
========================================
...
MODEL_PATH = os.path.join(SCRIPT_DIR, ".", "DH116S-L000-A1.xml")
...
def print_info(model: "mujoco.MjModel") -> None:
    print("=" * 58)
    print("  DH116S-L000-A1  灵巧手  MuJoCo 交互仿真")
    print("=" * 58)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="DH116S-L000-A1 MuJoCo 仿真")
