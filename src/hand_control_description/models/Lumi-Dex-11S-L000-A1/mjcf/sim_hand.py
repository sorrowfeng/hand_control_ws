...
# -*- coding: utf-8 -*-
"""
Lumi-Dex-11S-L000-A1 灵巧手（左手）MuJoCo 交互仿真
===============================================
...
MODEL_PATH = os.path.join(SCRIPT_DIR, ".", "Lumi-Dex-11S-L000-A1.xml")

# ─── 关节描述（仅供终端打印） ────────────────────────────────────────
ACTIVE_DESC = {
    "act_finger11": "拇指侧摆  (MCP ab/adduction)  轴 +Z",
    "act_finger12": "拇指弯曲  (MCP flexion)        轴 -X",
    "act_finger21": "食指弯曲  (MCP flexion)        轴 -X",
    "act_finger31": "中指弯曲  (MCP flexion)        轴 -X",
    "act_finger41": "无名指弯曲(MCP flexion)        轴 -X",
    "act_finger51": "小拇指弯曲(MCP flexion)        轴 -X",
}
PASSIVE_DESC = [
...
def print_info(model: "mujoco.MjModel") -> None:
    print("=" * 60)
    print("  Lumi-Dex-11S-L000-A1  灵巧手（左手）  MuJoCo 交互仿真")
    print("=" * 60)
