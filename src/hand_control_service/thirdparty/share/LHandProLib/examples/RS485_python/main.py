#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""LHandProLib RS485 motion loop example."""
...
def main():
    print("LHandProLib RS485 循环运动示例")
    print("=" * 50)

    with LHandProLibController(communication_mode="RS485") as controller:
        try:
            print("\n正在连接 RS485 设备...")
            ...
            if not connected:
                print("设备连接失败，请检查硬件连接和 RS485 配置")
                return 1
